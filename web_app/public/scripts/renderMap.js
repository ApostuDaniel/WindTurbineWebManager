...
function initMap() {
  ...
  map.addListener("click", async mapsMouseEvent => {
    ...
    await updateAtributes(locat, lat, lng, weatherDescription, wind, temp, hum, alt, sol, suit);
...
async function updateAtributes(locat, lat, lng, weatherDescription, wind, temp, hum, alt, sol, suit) {
